package com.zafatar.reservation.api.v1.config;
...
public class RedisConfiguration {
    ...
    RedisConnectionFactory jedisConnectionFactory() {
    	...
    	rsc.setHostName(this.redisHost);
    	rsc.setPort(this.redisPort);
    	rsc.setDatabase(this.redisDatabase);
    	
        JedisConnectionFactory jedisConFactory = new JedisConnectionFactory(rsc);
